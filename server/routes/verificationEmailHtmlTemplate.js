function verificationEmailHtmlTemplate({ username, verificationUrl, baseUrl }) {
  return `
  <!DOCTYPE html>
                                      ...
                                      <tr>
                                        ...
                                        >
                                          <img
                                            ...
                                            class="icon"
                                            height="auto"
                                            src="https://d312364fea.imgdist.com/pub/bfra/pu1huc1n/jwj/388/rzo/email-check-icon-lg.png"
                                            style="
                                              display: block;
                                              height: auto;
                                              margin: 0 auto;
                                  ...
                                  >
                                    ...
                                    >
                                      <p style="margin: 0; margin-bottom: 16px">
                                        <strong>Welcome to Dev-Blog ${username}</strong>
                                      </p>
                                      <p style="margin: 0; margin-bottom: 16px">
                                        We're excited to have you on board!
                                      </p>
                                      <p style="margin: 0; margin-bottom: 16px">
                                        Please verify your email by clicking verify email button below
                                      </p>
                                      <p style="margin: 0">
                                        <strong
                                          >The link will expire in 6
                                          hours.</strong
                                        >
                                      </p>
                                    </div>
                              ...
                              >
                                <tr>
                                  <td class="pad">
                                    <div align="center" class="alignment">
                                      <!--[if mso]>
  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${verificationUrl}" style="height:42px;width:104px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#170f2e">
  <w:anchorlock/>
...
module.exports = verificationEmailHtmlTemplate;
